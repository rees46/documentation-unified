            ...
            '/integration/': [
                { text: 'План интеграции', link: '/integration/index.md' },
                {
                    ...
                    items: [
                        ...
                        {
                            text: 'Корзина клиента',
                            collapsed: true,
                            items: [
                                { text: 'Содержимое корзины', link: '/integration/cdp/cart/cart.md' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: 'API и SDK', link: '/integration/listing/api.md' },
                        { text: 'Фасетный поиск', link: '/integration/listing/facet.md' },
                    ]
                },
                {
