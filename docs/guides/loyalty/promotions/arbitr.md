...
![Несовместимость акций](images/promo_restrictions.png)
...
## Оценка комбинаций (метод [checkout/estimate](../../../integration/loyalty/checkout/estimate.md))
...
1. Checkout-controller получает запрос ([checkout/estimate](../../../integration/loyalty/checkout/estimate.md))
