...
| items[]      | Да          | Массив идентификаторов товаров. Пустой `ID` или `ID` длиннее 255 символов будут проигнорированы. Если все переданные ID невалидны, запрос вернёт ошибку `422` |
