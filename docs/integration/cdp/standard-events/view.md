...
| items[].id       | Да          | Идентификатор (артикул) товара, который указан в импорте товара. Пустой ID или ID длиннее 255 символов будут проигнорированы. Если все переданные ID невалидны, запрос вернёт ошибку 422 |
