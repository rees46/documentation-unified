# Восстановить заблокированный сертификат

Разблокирует ранее заблокированный сертификат.

```
PATCH https://api.rees46.ru/loyalty/certificates/unblock
```
...
curl --header "Content-Type: application/json" \
  ...
  https://api.rees46.ru/loyalty/loyalty/certificates/unblock
```
