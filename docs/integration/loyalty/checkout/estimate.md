...
| use_personal_certificates | Нет         | Булевый флаг, использовать ли именные сертификаты без их передачи в запросе. Если `true`, то процессинг найдет все активные именные сертификаты клиента и попытается применить их автоматически                                                                                                                     |
| location_id               | Нет         | Идентификатор локации (города, точки продаж) из товарого фида                                                                                                                                                                                                                                                       |
