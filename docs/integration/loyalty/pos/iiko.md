...
2. Кассир переходит к этапу использования инструментов программы лояльности. Для этого нужно нажать на кнопку _REES46 Checkout_

![Применить скидку](./images/iiko-order-discount-checkout.png)
